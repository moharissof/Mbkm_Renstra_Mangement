    ...
    const fetchProgramsByBidang = async () => {
      ...
      try {
        const response = await fetch(
          `/api/pengajuan/kabag?user_id=${user.id}&status=Planning`
        );
      ...
      <div className="p-6 space-y-6">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-2xl font-bold">
              Daftar Pengajuan Proker Bawahan Anda!
            </h1>
        ...
        {loading ? (
          ...
          <DataTableCard
            ...
            data={programs}
            title={`Program Kerja Bawahan Anda`}
            description={`Verifikasi Dan Setujui Proker Bawahan Anda`}
            searchColumn="nama"
