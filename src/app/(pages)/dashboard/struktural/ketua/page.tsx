  ...
  useEffect(() => {
    const fetchStaffData = async () => {
      ...
      try {
        ...
        const response = await fetch(`/api/struktur/ketua?user_id=${user.id}`)
        ...
        <div className="grid gap-6">
          ...
          {loading ? (
            ...
            <DataTableCard
              ...
              data={staffData}
              title={"Pantau kinerja staf"}
              description={"Analisis kinerja staf berdasarkan program yang sedang berjalan"}
              searchColumn="name"
              pageSize={10}
            />
          )}
